...
@CucumberOptions(features = "src/test/resources/Features",glue = "StepDefinations",
        ...
        tags = " @new_member_dc_us or @all_wallet_features_us or @all_card_features or @cs_card_topup_us or @others " ,
...
*** @all_us   ----> All stable features for US members will run by this tag
